...
// Owner-only (firestore.rules). While true, the seller cannot create new
// ads — used when they owe an unpaid/overdue commission.
export async function setUserCommissionBlock(uid: string, blocked: boolean) {
